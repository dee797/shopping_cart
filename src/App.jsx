  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="grid grid-rows-1 grid-cols-5 w-full">
        <div className="col-span-3 row-span-3"><img className="w-full h-full" src="src/assets/hannah-morgan-ycVFts5Ma4s-unsplash.jpg" alt="Picture of clothes" width="300px" height="300px"/></div>
        <div className="flex flex-col justify-start gap-y-5 col-span-2">
          ...
          <div className="my-4 px-16 text-xl text-gray-700 flex flex-col gap-y-10">
            ...
            <p className="">We offer a variety of women's clothing, from jackets, to blouses, to turtlenecks, and more!</p>
          </div>
          <div className="my-10 flex justify-center items-center">
            <Link to="shop" className="btn px-20 py-4 rounded-lg font-medium text-neutral-50 text-x">Shop Now</Link>
          </div>
        </div>
      </div>
