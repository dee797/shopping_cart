  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="grid grid-rows-1 grid-cols-5 w-full">
        <div className="col-span-3 row-span-3"><img className="w-full h-full" src="src/assets/hannah-morgan-ycVFts5Ma4s-unsplash.jpg" alt="Picture of clothes" width="500" height="300"/></div>
