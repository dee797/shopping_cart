...
const App = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      <header className="mb-2 px-4 bg-cyan-800">
        <div className="relative mx-auto py-4 flex max-w-screen-lg flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav aria-label="Header Navigation" className="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
            <ul className="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
              <li className=""><Link className="text-neutral-50 hover:text-neutral-200" to="/">Home</Link></li>
              <li className=""><Link className="text-neutral-50 hover:text-neutral-200" to="shop">Shop</Link></li>
              <li className=""><Link className="text-neutral-50 hover:text-neutral-200" to="/" >Cart</Link></li>
            </ul>
          </nav>
        </div>
      </header>
