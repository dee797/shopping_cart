              ...
              <div className="flow-root">
                <ul className="-my-8">
                  ...
                  {Object.keys(cartItems).map((item) => {
                    return (
                      <CartItem image={cartItems[item].product.image} title={cartItems[item].product.title} price={cartItems[item].product.price} quantity={cartItems[item].quantity} rating={cartItems[item].product.rating.rate} key={item}/>
                    );
                  })}
